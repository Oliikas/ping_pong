...
#ігрова сцена:
background = transform.scale(image.load("pp5.jpg"), (700, 500))  
win_width = 600
win_height = 500
...
ball = GameSprite('b6.png', 200, 200, 4, 50, 50)

# Ось наша кнопка перезавантаження гри.
butReset = GameSprite('res6.png', 240, 200, 0, 150, 100)
...
lose1 = font.render('PLAYER 1 LOSE!', True, (240, 25, 210))
lose2 = font.render('PLAYER 2 LOSE!', True, (240, 25, 210))

win1 = font.render('PLAYER 1 WIN!!!', True, (70, 250, 5))
win2 = font.render('PLAYER 2 WIN!!!', True, (70, 250, 5))
...
while game:
    ...
    if finish != True:
        ...
        if ball.rect.x < 50 and score_1 < 3:
            finish = True
            score_1 += 1
        ...
        if ball.rect.x > win_width- 50 and score_2 < 3:
            finish = True
            score_2 += 1
        ...
        if score_1 == 3:
            ...
            window.blit(font.render("Рахунок першого гравця " + str(score_1), True, (50, 50, 50)), (160, 40))
            ...
            window.blit(font.render("GAME OVER", True, (250, 230, 5)), (230, 0))
        ...
        if score_2 == 3:
            ...
            window.blit(font.render("Рахунок ДРУГОГО гравця " + str(score_2), True, (250, 50, 50)), (160, 40))
            ...
            window.blit(font.render("GAME OVER", True, (250, 230, 10)), (230, 0)) 
